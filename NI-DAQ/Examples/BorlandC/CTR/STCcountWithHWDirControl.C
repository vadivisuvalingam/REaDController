...
*     is LOW. (for devices with the DAQ-STC counter/timer) NOTE: To
...
*    Connect your digital pulse train to the PFI8/GPCTR0_SOURCE pin.
*     Connect your digital direction control signal to DIO6. Connect
...
void main(void)
{
    ...
    /* Load initial count.i Start counting from 10000 to avoid
     overflow. */
    ...
    printf(" Apply your digital pulse train to PFI8.\n");

    printf(" Notice the counting direction changes as you change the digital state of the direction control signal on DIO6.\n");
