...
*     Reference Manual. NOTE: To make this example work on the devices
...
*    Connect your digital pulse train to the PFI9/GPCTR0_GATE pin.
...
void main(void)
{
    ...
    printf(" Apply your trigger pulse train to PFI9 now.\n");
