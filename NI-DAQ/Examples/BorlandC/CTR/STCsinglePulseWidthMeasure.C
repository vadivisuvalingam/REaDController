...
*     See NOTE below!) NOTE: To make this example work on the devices
...
*    Connect your single digital pulse signal to the PFI9/GPCTR0_GATE
...
void main(void)
{
    ...
    printf(" Apply your digital pulse to PFI9 now.\n");
